class RoundRobin:
    ...
    def processData(self):
        ...
        '''
        process_data.append([1,7,12,0,12])
        process_data.append([2,5,11,0,11])
        process_data.append([3,6,9,0,9])
        process_data.append([4,14,13,0,13])
        process_data.append([5,0,17,0,17])
    ...
    def schedulingProcess(self, process_data, time_slice):
        ...
        RoundRobin.printData(self, process_data, t_time, w_time,backup_ready_queue, executed_process,start_time,exit_time)
    ...
    def printData(self, process_data, average_turnaround_time, average_waiting_time,backup_ready_queue, executed_process,start_time,exit_time):
        ...
        #print(backup_ready_queue)
        print('Sequence of Ready queue:' )
        while(len(backup_ready_queue)!=0):
            first= backup_ready_queue.pop(0)
            r=first.pop(0)
            print(r,end=', ')
        print()
        print(f'Sequence of Processes: {executed_process}')
        print(f'starting time : {start_time}')
        print(f'ending time : {exit_time}')
